...
<div class="wrapper">
  ...
  <?php
    ...
    // Display selected article data based on id
    // Getting id from url
    $id = $_GET['id'];
    
    // Fetech article data based on id
    $result = mysqli_query($connection, "SELECT * FROM article WHERE id=$id");
    
    while($article_data = mysqli_fetch_array($result))
    {
        $title = $article_data['title'];
        $description = $article_data['description'];
        $content = $article_data['content'];
        $posted_date = $article_data['posted_date'];
    }
  ?>
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="edit-articles.php?id=<?php echo $id;?>">Edit Article</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <form action="../../controller/edit-article.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="email" class="form-control" value="<?php echo $description;?>">
                        </div>
                        <div class="form-group">
